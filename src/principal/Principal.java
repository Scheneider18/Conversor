...
import conversorMoneda.MenuConversorMoneda;
import conversorTemperatura.MenuConversorTemperatura;

public class Principal {

	public static void main(String[] args) {

		MenuConversorMoneda monedas = new MenuConversorMoneda();
		MenuConversorTemperatura temperatura = new MenuConversorTemperatura();
